          ...
          <div class="list-group-item">
                <div class="media col-md-3">
                    <figure class="pull-left">
                        <img class="media-object img-rounded img-responsive"  src="images/photo-gallery01.jpg" alt="placehold.it/350x250" >
                    </figure>
                </div>
                <div class="col-md-6">
                    <h4 class="txt5"> List group heading </h4>
                    <p class="txt23"> Qui diam libris ei, vidisse incorrupte at mel. His euismod salutandi dissentiunt eu. Habeo offendit ea mea. Nostro blandit sea ea, viris timeam molestiae an has. At nisl platonem eum. 
                ...
                <div class="col-md-3 text-center txt25">
                    <h3> Rp  10000 </h3>
                </div>
          </div>
          <div class="list-group-item">
